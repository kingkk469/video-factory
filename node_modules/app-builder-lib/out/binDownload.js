...
function doGetBin(name, url, checksum) {
    ...
    const fs = require("fs");
    const cacheDir = process.env.ELECTRON_BUILDER_CACHE || path2.join(process.env.LOCALAPPDATA || (process.env.HOME + "/.cache"), "electron-builder", "Cache");
    const binPath = path2.join(cacheDir, name);
